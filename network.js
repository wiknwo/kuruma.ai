class ArtificialNeuralNetwork {
    ...
    static mutate(network, amount=1) {
        // Randomizes network to a certain percentage 
        // amount percent. If amount is set to 0, biases 
        // and weights remain the same. If amount set to
        // 1, mutate() functions like the #randomize 
        // function. If set to say 0.1 then you will get 
        // a network that is like the original but with 
        // 10% of randomization added.
